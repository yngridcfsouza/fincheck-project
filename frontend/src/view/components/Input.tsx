  ...
  return(
    <div className="relative">
      <input
        ...
        id={inputId}
        className={cn(
          "bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 pt-4 peer placeholder-shown:pt-1 focus:border-gray-800 transaction-all outline-none",
